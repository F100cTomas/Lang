...
\chapter{Úvod}
Jako cíl svého projektu jsem si vymezil tvorbu compileru pro jednoduchý programovací jazyk. Mám v plánu, že na projektu budu pokračovat i po maturitní
zkoušce, takže chci, aby šel projekt snadno rozšiřovat a příliš mi nezáleží na komfortu uživatele jazyka. To znamená, že mým hlavním cílem je implementace
základních jazykových konstrukcí, nikoli plnohodnotného jazyka. Mezi věci, které chci implementovat patří smyčky, podmínky, operátory, proměnné, funkce a další.

Následuje programátorská dokumentace. Obsahuje popis obecné struktury projektu a všech systémů, ze kterých se projekt skládá.
